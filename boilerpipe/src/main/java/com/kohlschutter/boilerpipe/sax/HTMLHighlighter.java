...
public final class HTMLHighlighter {
  ...
  public static final String BOILERPIPE_MARK_CSS_CLASS_NAME = "x-boilerpipe-mark1";
  public static final String BOILERPIPE_MARK_CSS_NON_ARTICLE_CLASS_NAME = "x-boilerpipe-mark1_nonArticle";

  private boolean outputHighlightOnly = false;
  private String extraStyleSheet = "\n<style type=\"text/css\">\n" + "." + BOILERPIPE_MARK_CSS_CLASS_NAME + " {"
