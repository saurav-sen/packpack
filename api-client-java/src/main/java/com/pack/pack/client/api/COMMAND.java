...
public enum COMMAND {
	...
	SIGN_IN(APIConstants.Login.CLIENT_KEY, APIConstants.Login.CLIENT_SECRET,
			...
			APIConstants.User.USER_ID), GET_USER_BY_USERNAME(
			APIConstants.User.USERNAME), SEARCH_USER_BY_NAME(
			APIConstants.User.SEARCH_USER_BY_NAME), GET_USER_FOLLOWED_TOPIC_LIST(
			APIConstants.PageInfo.PAGE_LINK, APIConstants.User.USER_ID), FOLLOW_TOPIC(
			APIConstants.User.USER_ID, APIConstants.Topic.TOPIC_ID), NEGLECT_TOPIC(
			APIConstants.Topic.TOPIC_ID, APIConstants.User.USER_ID), GET_TOPIC_BY_ID(
			APIConstants.Topic.TOPIC_ID), CREATE_NEW_TOPIC(
