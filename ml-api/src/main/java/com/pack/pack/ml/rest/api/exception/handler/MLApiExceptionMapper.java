package com.pack.pack.ml.rest.api.exception.handler;
 ...
 */
@Provider
public class MLApiExceptionMapper implements ExceptionMapper<Throwable> {
	
	private static Logger logger = LoggerFactory.getLogger(MLApiExceptionMapper.class);
